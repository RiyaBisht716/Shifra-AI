...
const themes = {
  ...
  light: {
    bg:
      "bg-linear-to-br from-white via-[#f8fafc] to-[#eef6ff]",
    ...
    <div className='flex items-center justify-center px-3 sm:px-4 py-10 sm:py-14'>
        ...
        <div className={`relative w-70 h-112.5 sm:w-82.5 sm:h-125 md:w-95 md:h-137.5 rounded-4xl sm:rounded-[42px] overflow-hidden transition-all duration-500 ${current.bg} ${current.cardBorder} shadow-[0_20px_80px_rgba(0,0,0,0.28)]`}>
          ...
          <button
            ...
            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-linear-to-br from-white/80 to-white/20 border transition-all cursor-pointer ${
              theme === "glass"
          ...
          <button
            ...
            className={`w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-linear-to-r from-emerald-400 to-green-500 border transition-all cursor-pointer ${
              theme === "neon"
          ...
          <div className='relative z-20 flex flex-col items-center justify-between h-full px-5 py-6 sm:px-7 sm:py-8'>
           ...
           <div className='text-center'>
            ...
            <p className={`mt-4 text-[13px] sm:text-[15px] md:text-[16px] leading-6 sm:leading-7 max-w-70 mx-auto ${current.sub}`}>
           ...
           <div className='relative mb-1'>
            ...
            <button className={`relative w-12 h-12 sm:w-15 sm:h-15 md:w-18 md:h-18 rounded-full bg-linear-to-br ${current.button} ${current.micGlow} flex items-center justify-center`}>
