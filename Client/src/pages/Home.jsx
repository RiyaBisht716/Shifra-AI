  ...
  return (
    <div className='min-h-screen bg-[#f8fafc] overflow-hidden'>
      ...
      <section className='relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20'>
        ...
        <div className="absolute top-0 left-1/4 w-80 h-80 bg-purple-200/40 blur-3xl rounded-full" />

        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-emerald-200/40 blur-3xl rounded-full" />
        ...
        <div className='relative max-w-6xl mx-auto'>
          ...
          <div className='text-center mt-10 sm:mt-12'>
            <h1 className='max-w-5xl mx-auto text-[42px] leading-13 sm:text-6xl sm:leading-18 lg:text-7xl lg:leading-22 font-black tracking-[-0.04em] text-[#081028]'>
              Add a{" "}
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center gap-4 mt-10'>
              <button onClick={()=>navigate("/builder")} className='w-full sm:w-auto px-8 py-4 rounded-2xl bg-linear-to-r from-purple-500 to-emerald-500 text-white font-semibold text-sm sm:text-base shadow-[0_12px_40px_rgba(168,85,247,0.25)] hover:scale-[1.02] transition-all cursor-pointer'>
        ...
        <div className='max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left'>
          <div>
            <div onClick={()=>navigate("/")} className='flex items-center gap-2.5'>
                    ...
                    <h1 className='font-bold text-xl text-gray-100 leading-none'>Shifra{" "}<span className='text-transparent bg-clip-text bg-linear-to-r from-purple-500 to-emerald-500'>AI</span></h1>
          ...
          <p className='text-gray-500 text-sm'>
            © {new Date().getFullYear()} ShifraAI by Riya Bisht. All rights reserved.
          </p>
